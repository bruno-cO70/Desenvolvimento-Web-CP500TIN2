...
async function cadastrar() {
    ...
    if (error) {
        ...
        document.getElementById('mensagem').innerText = "Cadastro realizado! Verifique seu e-mail para confirmar.";
    }
}
...
async function entrar() {
    ...
    if (error) {
        document.getElementById('mensagem').innerText = "Erro ao entrar: Verifique e-mail e senha.";
    } else {
        document.getElementById('mensagem').innerText = "Login feito com sucesso! Bem-vindo.";
